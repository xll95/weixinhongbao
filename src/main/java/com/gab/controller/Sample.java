...
public class Sample {
    ...
    private static final String apiKey = "Konkv9f8ZZ0TSQ3YQlDDymVm";
    private static final String secretKey = "K4vI2io6fv9iaZxACppY1R8sbWR4MtQz";
    private static final String cuid = "11703425";
